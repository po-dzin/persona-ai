    ...
    <div className="overlay-screen photo-viewer-screen" onClick={shareOpen || menuOpen ? closeAll : undefined}>
      ...
      <div className="viewer-body">
        <div className="viewer-actions-row">
          <button className="viewer-icon-btn viewer-heart-btn" onClick={onToggleFavorite} aria-label={isFavorite ? "Убрать из избранного" : "Добавить в избранное"} title={isFavorite ? "Убрать из избранного" : "Добавить в избранное"}>
            {isFavorite ? (
        ...
        <div className="viewer-style-block">
          <div className="viewer-style-label">Стиль</div>
          <div className="viewer-style-value">{style?.name || photo.styleCode}</div>
        </div>
