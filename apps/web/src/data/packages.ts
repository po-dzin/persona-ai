...
export const FALLBACK_PACKAGES: PackageItem[] = [
  ...
  { code: "BASIC",   title: "Basic",   credits: 350,  bonusCoins: 20,   bonusPercent: 5,  priceStars: 537,  provider: "telegram_stars" },
  { code: "POPULAR", title: "Popular", credits: 800,  bonusCoins: 80,   bonusPercent: 10, priceStars: 1227, provider: "telegram_stars" },
